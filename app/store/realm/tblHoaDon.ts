...
const tblHoaDon: Realm.ObjectSchema = {
  ...
  properties: {
    ...
    ptChietKhauHang: {type: 'float', default: 0},
    tongChietKhauHangHoa: 'float',
    tongTienHang: 'float',
    ptThueHD: {type: 'float', default: 0},
    tongTienThue: {type: 'float', default: 0},
    tongTienHDSauVAT: 'float',
    ptGiamGiaHD: 'float',
    tongGiamGiaHD: 'float',
    chiPhiTraHang: {type: 'float', default: 0},
    tongThanhToan: 'float',
    chiPhiHD: {type: 'float', default: 0},
    ghiChuHD: 'string?',
